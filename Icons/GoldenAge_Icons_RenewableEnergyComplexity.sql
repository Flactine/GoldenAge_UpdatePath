...
VALUES	('ICON_RESOURCE_JNR_BATTERY_CHARGE',				'ICON_ATLAS_JNR_RENEWABLE_RESOURCES',		0),
		...
		('ICON_BUILDING_ASSEMBLYLINE',						'ICON_ATLAS_JNR_CB_REC_BUILDINGS',			1),
		('ICON_BUILDING_ASSEMBLYLINE_FOW',					'ICON_ATLAS_BUILDINGS_FOW',					27),
		('ICON_BUILDING_AUTOMATED',							'ICON_ATLAS_JNR_CB_REC_BUILDINGS',			1),
		('ICON_BUILDING_AUTOMATED_FOW',						'ICON_ATLAS_BUILDINGS_FOW',					27);