...
local NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS	:number = 10;--Gold
...
function GetBonusText( playerID:number, envoyTokenNum:number )
	...
	elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusTypeText = Locale.Lookup("LOC_MINOR_CIV_LARGEST_INFLUENCE_ENVOYS");--Gold
	...
	if (leader == "LEADER_MINOR_CIV_SCIENTIFIC" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_SCIENTIFIC") then
		...
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_SCIENTIFIC_TRAIT_LARGEST_INFLUENCE_BONUS");--Gold
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_RELIGIOUS" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_RELIGIOUS") then
		...
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_RELIGIOUS_TRAIT_LARGEST_INFLUENCE_BONUS");--Gold
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_TRADE" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_TRADE") then
		...
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS");--Gold
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_CULTURAL" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_CULTURAL") then
		...
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_CULTURAL_TRAIT_LARGEST_INFLUENCE_BONUS");--Gold
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_MILITARISTIC" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_MILITARISTIC") then
		...
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_MILITARISTIC_TRAIT_LARGEST_INFLUENCE_BONUS");--Gold
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	elseif (leader == "LEADER_MINOR_CIV_INDUSTRIAL" or leaderInfo.InheritFrom == "LEADER_MINOR_CIV_INDUSTRIAL") then
		...
		elseif envoyTokenNum == NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS then bonusDetailsText = Locale.Lookup("LOC_MINOR_CIV_INDUSTRIAL_TRAIT_LARGEST_INFLUENCE_BONUS");--Gold
		else UI.DataError("Unknown envoy number for city-state type bonus: " .. tostring(envoyTokenNum));
		end
	else
...
function AddCityStateRow( kCityState:table )
	...
	kInst.BonusImage10:SetToolTipString( kCityState.Bonuses[10].Title .."[NEWLINE]".. kCityState.Bonuses[10].Details );
	...
	for i, pPlayer in ipairs(PlayerManager.GetAliveMinors()) do
		...
		if iPlayer ~= pLocalPlayer:GetID() and isCanReceiveInfluence then
			...
			local kCityState :table		= {
				...
				isBonus10				= (envoyTokens >= NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS),--Gold
			...
			title, details = GetBonusText( iPlayer, NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS );--Gold
			kCityState.Bonuses[ NUM_ENVOY_TOKENS_FOR_FOURTH_BONUS ] = { Title = title, Details = details } --Gold
			...
			if m_kLastCityStates ~= nil and m_kLastCityStates[iPlayer] ~= nil then
				...
				--Gold
				if kCityState.isBonus10 then
					if not m_kLastCityStates[iPlayer].isBonus10 then
						isNewBonusAchieved = true;
					end
				end
				--/Gold
